  ...
  return class MakeBuildProvider extends EventEmitter {
    ...
    isEligible() {
      try {
        ...
        this.projectName = getXPath('projectName', doc);
        this.builderCommand = getXPath('builderCommand', doc);
        this.builderArguments = getXPath('builderArguments', doc);
        this.builderTarget = getXPath('builderTarget', doc);
        return (
    ...
    settings() {
      ...
      const args = this.builderArguments.trim().split(' ');

      const defaultTarget = this.builderTarget ? this.builderTarget : 'all';

      return {
        name: this.projectName + ' ' + defaultTarget,
